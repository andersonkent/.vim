...
execute "command! -nargs=1 Colo let g:moria_style = \"<args>\" | colo moria2"
...
let colors_name = "moria2"

if &background == "dark"
    if s:moria_style == "dark"
        hi Normal ctermbg=0 ctermfg=7 guibg=#181818 guifg=#c0c0c0 gui=none

        hi ColorColumn ctermbg=8 ctermfg=15 guibg=#494949 gui=none
        hi CursorColumn ctermbg=8 ctermfg=15 guibg=#404040 gui=none
        hi CursorLine ctermbg=8 ctermfg=15 guibg=#272727 gui=none
    elseif s:moria_style == "black"
        ...
        hi CursorLine ctermbg=8 ctermfg=15 guibg=#1a1a1a gui=none
    endif
    ...
    hi Comment guibg=bg guifg=#505050 gui=none
    ...
    hi TagListFileName guifg=black guibg=Gray gui=bold
elseif &background == "light"
    ...
    hi Comment guibg=bg guifg=#584000 gui=none
